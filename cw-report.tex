...
\begin{document}
	...
	\centering{
		...
		\begin{enumerate}[]
			...
			\item При делении совершается деление и приписывается минус.
		\end{enumerate}
		...
		Класс \code{Z8Number} содержит в себе поля для хранения данных о числе и функции для проведения операций над ними.
